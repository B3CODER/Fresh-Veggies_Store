...
import { ShoppingCart, Search, X, Minus, Plus, Leaf, User, LogOut } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center gap-2">
            <div className="relative">
              <button
                ...
                className="flex items-center gap-1.5 bg-gray-50 hover:bg-gray-100 text-gray-700 px-2.5 py-1.5 rounded-xl text-sm font-medium transition-colors"
              >
              ...
              {menuOpen && (
                <>
                  ...
                  <div className="absolute right-0 mt-2 z-20 bg-white rounded-xl shadow-lg border border-gray-100 py-1 w-44">
      ...
      <div className="max-w-xl mx-auto px-4 pb-24">
        ...
        <div className="mt-4 mb-5">
          <h1 className="text-xl font-bold text-gray-900">{settings?.store_name ?? 'Fresh Veggies'}</h1>
        ...
        <div className="relative mb-4">
          ...
          <input
            ...
            className="w-full pl-9 pr-9 py-2.5 border border-gray-200 rounded-xl bg-white text-sm focus:outline-none focus:ring-2 focus:ring-green-400"
          />
          {search && (
          ...
          {(['all', 'available'] as const).map((f) => (
            <button
              ...
              className={`px-3 py-1.5 rounded-xl text-xs font-semibold capitalize transition-colors ${
                filterAvail === f ? 'bg-green-600 text-white' : 'bg-white text-gray-600 border border-gray-200'
              }`}
            >
        ...
        {/* Today's label */}
        <h2 className="font-bold text-gray-800 mb-3">Today's Fresh Vegetables</h2>
                ...
                <div key={v.id} className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100">
                  ...
                  <div className="p-3">
                    ...
                    <p className="text-green-600 font-bold text-sm mt-0.5">
                      {formatPrice(v.price)}
                      <span className="text-gray-400 font-normal text-xs">/{v.unit}</span>
                    </p>
                    ...
                    {v.is_available ? (
                      qty === 0 ? (
                        ...
                        <div className="flex items-center justify-between mt-2 bg-green-50 rounded-xl px-1 py-1">
                          <button
                            onClick={() => updateQuantity(v.id, qty - 1)}
                            className="w-8 h-8 bg-white rounded-lg shadow-sm flex items-center justify-center text-green-700 hover:bg-green-100 transition-colors"
                          >
                      ...
                      <div className="mt-2 bg-gray-100 text-gray-400 text-xs font-semibold py-2 rounded-xl text-center">
                        Unavailable
                      </div>
                    )}
                  </div>
