  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-2xl px-4 py-3 mb-4 text-sm text-center">
          <p className="font-semibold text-green-800 dark:text-green-400 mb-0.5">Default Credentials</p>
          <p className="text-green-700 dark:text-green-400 font-mono">admin@freshveggies.com</p>
          <p className="text-green-700 dark:text-green-400 font-mono">Admin@1234</p>
        </div>

        <form
          onSubmit={handleSubmit}
          className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-6 space-y-4"
        >
          <div>
